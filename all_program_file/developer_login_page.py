...
import time 
import psycopg2
class DevelopLogInPage():
    def __init__(self,root):
        self.root=root
        self.root.title("Develop LogIn Page")
                    ...
                    if self.var_user_confirm_password.get()=='':
                        ...
                        if self.var_user_password_sing_up.get()!=self.var_user_confirm_password.get():
                            ...
                            if self.sing_upotp!=self.var_user_email_otp_sing_up.get():
                                ...
                                cur.execute('insert into developer_sing_up_data (user_email,otp,user_password,user_confirm_password) values(%s,%s,%s,%s)',(
        ...
        if self.var_user_email.get()=='':
            ...
            if self.var_pass_word.get()=='':
                ...
                if self.var_otp.get()=='':
                    ...
                    cur.execute('select user_password from developer_sing_up_data where user_email=%s',(self.var_user_email.get(),))
